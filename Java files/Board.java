...
/* Custom made boards with predefined positions for snakes and ladders*/

class CustomBoard1 implements Board{
  private int destination = 100;
  private HashMap<Integer,Snake> snakes = new  HashMap<Integer,Snake>();
  private HashMap<Integer,Ladder> ladders = new  HashMap<Integer,Ladder>();
  public int getDestination() {
...
/*
class CustomBoard2 implements Board{
  private int destination = 100;
  private HashMap<Integer,Snake> snakes = new  HashMap<Integer,Snake>();
  private HashMap<Integer,Ladder> ladders = new  HashMap<Integer,Ladder>();
  public int getDestination() {
...
class CustomBoard3 implements Board {
  private int destination = 100;
  private HashMap<Integer,Snake> snakes = new  HashMap<Integer,Snake>();
  private HashMap<Integer,Ladder> ladders = new  HashMap<Integer,Ladder>();
  public int getDestination() {
